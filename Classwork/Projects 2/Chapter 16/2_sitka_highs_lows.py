...
for row in reader:
    ...
    high = int(row[4]) #this is grabbing info in row 4 and assigning all the info to the high var
    low = int(row[5])  #this is grabbing info in row 5 and assigning all the info to the high var
